...
/** @public Reserved metadata copy; not yet wired into a rendered slot. */
...
//
// NOTE: the current hero renders its manifesto copy inline (the BEATS array in
// BlackHole.tsx). The exports below are the intended page copy, kept as the
// source of truth for when the long-form sections get wired up. They are tagged
// `@public` so `knip` won't report them as unused while they wait.

/** @public The role shown under the name in the hero's top-left identity slot. */
export const HERO_ROLE = 'Software Engineer';

/** @public Sub-line under the personalized greeting in the hero. */
export const HERO_SUBLINE =
  'Engineer. I build small, precise things for the web and write down what I learned.';

/** @public The opening statement, one clause per line (revealed line by line). */
...
/** @public How I work: a short claim and the clause that earns it. */
