...
import luminet from '../../assets/inspirations/luminet-blackhole-1979.jpg';
...
{/* quality 55: the 2215px source photo lands its largest delivered variant
    (AVIF at 1360w, the 2x of the prose column) around 146KB — the asset this
    replaces shipped as a raw 4MB jpg. */}
<figure>
  <Img
    src={voyager}
...
I realized those two things are the same thing. Both are points of light against a void. Both are someone deciding to build something carefully, honestly, and meant to last longer than they will. That is the whole reason this site looks the way it does. A million points of light, a star living its life in reverse, and the black hole right at the top — the page opens on the collapse and rewinds to a lone pale blue dot at the bottom. I wanted to make Luminet's drawing move.
